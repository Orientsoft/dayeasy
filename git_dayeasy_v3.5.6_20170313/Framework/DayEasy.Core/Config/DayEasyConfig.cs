...
namespace DayEasy.Core.Config
{
    ...
    {
        /// <summary> 发件邮箱 </summary>
        [XmlAttribute("senderEmail")]
        public string SenderEmail { get; set; }

        /// <summary> 发件邮箱密码 </summary>
        ...
        /// <summary> 是否使用加密连接 </summary>
        [XmlAttribute("useSsl")]
        public bool UseSsl { get; set; }
    }

    /// <summary> 消息模版配置 </summary>
    [Serializable]
