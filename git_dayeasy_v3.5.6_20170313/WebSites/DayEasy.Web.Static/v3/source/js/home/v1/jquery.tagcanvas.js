...
TCproto.HideTags = function() {
  ...
  for(i = 0; i < el.length; ++i)
    el[i].style.display = 'none';  // 隐藏初始化图标
};
...
TagCanvas.tc = {};
TagCanvas.options = {
  //  具体参数：http://www.scutephp.com/topic-id117.html ，http://blog.csdn.net/nickroprak/article/details/40506325
z1: 20000,
z2: 20000,
z0: 0.0002,
freezeActive: false,
...
reverse: false,
depth: 0.5,
maxSpeed: 0.05,  //旋转最大速度
minSpeed: 0,     // 旋转的最小速度时，鼠标离开画布
decel: 0.95,
interval: 20,   //动画帧的时间间隔，以毫秒为单位
minBrightness: 0.1,
maxBrightness: 1,
