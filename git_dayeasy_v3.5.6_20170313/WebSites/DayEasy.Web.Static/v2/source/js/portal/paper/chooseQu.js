$(function () {
    ...
    var qEvents = {
        ...
        questionSearch: function () {
            ...
            $("#questionListDiv").load('/paper/questionlist', { star: star, sort: sort, qtype: qtype, kp: kp, queryKey: queryKey, qSourceType: qSourceType, year: year, area: area }, function () { });
        },
        ...
        paperSearch: function () {
            ...
            $("#paperDataDiv").load('/paper/paperdata', { grade: grade, source: source, key: key, kp: kp });
    ...
    //试卷详情页面选题收录全卷
    $("#paperDetails").delegate("#addAllQuestion", "click", qEvents.addAllPaperQuestion);
