define("v1/v1/portal/init-debug", [ "gallery/jquery/1.8.2/jquery-debug", "js/styles/component/v1/sliderwidget/nouisliderall-debug" ], function(require, exports) {
    var $ = require("gallery/jquery/1.8.2/jquery-debug"), noui = require("js/styles/component/v1/sliderwidget/nouisliderall-debug");
});
...
define("js/styles/component/v1/sliderwidget/nouisliderall-debug", [ "gallery/jquery/1.8.2/jquery-debug" ], function(require, exports, module) {
    ...
    (function($) {
        ...
        /** @const */
        doc = $(document), // Make a backup of the original jQuery/Zepto .val() method.
        /** @const */
        $val = $.fn.val, // Namespace for binding and unbinding slider events;
        /** @const */
        namespace = ".nui", // Determine the events to bind. IE11 implements pointerEvents without
        ...
        function closure(target, options, originalOptions) {
            ...
            var $Target = $(target), $Locations = [ -1, -1 ], $Base, $Handles, $Spectrum = options.spectrum, $Values = [], // libLink. For rtl sliders, 'lower' and 'upper' should not be inverted
            ...
            function getCurrentStep() {
                ...
                var retour = $.map($Locations, function(location, index) {
                    var step = $Spectrum.getApplicableStep(location), // As per #391, the comparison for the decrement step can have some rounding issues.
                    // Round the value to the precision used in the step.
                    stepDecimals = countDecimals(String(step[2])), // Get the current numeric value
                    value = $Values[index], // To move the slider 'one step up', the current step value needs to be added.
        ...
        function rebuild(options) {
            return this.each(function() {
                ...
                var values = $(this).val(), originalOptions = this.destroy(), // Extend the previous options with the newly provided ones.
